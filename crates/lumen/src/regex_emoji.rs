//! RGI emoji sequence data (generated from the test262 property-of-strings fixtures,
//! which mirror the Unicode emoji data files). Multi-code-point members of the
//! properties-of-strings; single code points live in the regular property tables.

/// RGI_Emoji_Flag_Sequence: regional-indicator pairs.
pub static RGI_FLAG_SEQUENCES: &[&str] = &[
    "\u{1F1E6}\u{1F1E8}",
    "\u{1F1E6}\u{1F1E9}",
    "\u{1F1E6}\u{1F1EA}",
    "\u{1F1E6}\u{1F1EB}",
...
pub static RGI_ZWJ_SEQUENCES: &[&str] = &[
...
/// The full RGI_Emoji set (union across Emoji versions).
pub static RGI_EMOJI_ALL: &[&str] = &[
    "\u{23}\u{FE0F}\u{20E3}",
    "\u{2A}\u{FE0F}\u{20E3}",
    "\u{30}\u{FE0F}\u{20E3}",
    "\u{31}\u{FE0F}\u{20E3}",
