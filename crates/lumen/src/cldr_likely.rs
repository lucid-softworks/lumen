//! CLDR likelySubtags table, generated by scripts/gen-cldr-likely.py. DO NOT EDIT.

#[rustfmt::skip]
static LIKELY: [(&str, &str); 7788] = [
    ("aa", "aa-Latn-ET"),
    ("aaa", "aaa-Latn-NG"),
    ("aab", "aab-Latn-NG"),
    ("aac", "aac-Latn-PG"),
...
pub fn likely(key: &str) -> Option<&'static str> {
    LIKELY.binary_search_by(|(k, _)| (*k).cmp(key)).ok().map(|i| LIKELY[i].1)
}
